...
public class WrappableVerticalLayoutManager extends LinearLayoutManager {

    public WrappableVerticalLayoutManager(Context context) {
        super(context, VERTICAL, false);
    }

    public WrappableVerticalLayoutManager(Context context, int orientation, boolean reverseLayout) {
